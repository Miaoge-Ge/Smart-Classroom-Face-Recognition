...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, embedding_size=512):
        super().__init__()
        self.in_planes = 64
...
def ResNet10(embedding_size=512):
    return ResNet(BasicBlock, [1, 1, 1, 1], embedding_size)

def ResNet50(embedding_size=512):
    return ResNet(Bottleneck, [3, 4, 6, 3], embedding_size)
